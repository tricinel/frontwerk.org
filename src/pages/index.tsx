...
const ExampleGrid: React.SFC = ({ children }): JSX.Element => (
          ...
          <MainContainer size={1170}>
            <Grid template="1fr" templatemd="1fr 1fr 1fr" gap={30}>
              <Box>
                ...
                <p>
                  Frontwerk is a zero configuration toolset aimed at helping
                  frontend developers. It abstracts a set of underlying tools
                  and their configurations in order to improve both the
                  developer experience and the time it takes to get started and
                  maintain a Javascript project.
                </p>
              </Box>
              <Box>
                <h3>Extensible</h3>
                <p>
                  Frontwerk has been designed from the ground up to be easy to
                  extend its tools configurations or even completely replace
                  them without having to give up the benefits of the toolset
                  itself.
                </p>
              </Box>
              <Box>
                ...
                <p>
                  ...
                  consistency across projects and across teams. You will be able
                  to start writing actual code in no time at all and not worry
                  about what tool to use to test it, what lint rules to follow
                  and what configuration your build should use.
                </p>
              </Box>
            </Grid>
          </MainContainer>
            ...
            <Grid template="1fr" gap={10}>
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    Frontwerk uses <strong>Jest</strong> under the hood as the
                    testing framework. You get all the power of Jest without any
                    of the headache of setting it up and configuring it.
                  </p>
                  <p>
              ...
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    ...
                    <strong>ESLint</strong>, coupled with widely used and
                    accepted presets, such as AirBnB&apos;s styleguide, Prettier
                    and accessibility.
                  </p>
                  <p>
              ...
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    ...
                    Because we write code for humans and not for machines,
                    Prettier takes care of how your code looks.
                  </p>
                  <p>
              ...
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    No matter if you write CSS or if you use a preprocessor like
                    SCSS to write your CSS, Frontwerk has you covered.{' '}
              ...
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    In today&apos;s modern browsers, we should aim to write
                    modern Javascript. That means ES6, but it also means some
                    browser might not support all features. This is where{' '}
                    <strong>BabelJS</strong> comes in. Frontwerk will use
                    BabelJS to compile your Javascript code to run in all
                    browsers.
                  </p>
                  <p>
              ...
              <ExampleGrid>
                <Box>
                  ...
                  <p>
                    ...
                    <strong>Webpack</strong> for SPAs and{' '}
                    <strong>RollupJS</strong> for libraries and provides default
                    configurations for both these bundlers.
                  </p>
                  <p>
                    <Link to="/docs/build">
                      Bundling with Webpack or RollupJS
                    </Link>
                  </p>
                </Box>
                <CodeBox>
